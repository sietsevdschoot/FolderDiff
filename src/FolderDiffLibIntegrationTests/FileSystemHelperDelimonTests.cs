...
namespace FolderDiffLibIntegrationTests
{
    ...
    public class FileSystemHelperDelimonTests
    {
        ...
        {
            var fileInfo = _fileSystem.FileInfo.FromFileName(GetRealPath(path));
        ...
        {
            // Arrange
            CreateFile(@"C:\Temp\Folder\1.txt");
            CreateFile(@"C:\Temp\Folder\2.txt");
            CreateFile(@"C:\Temp\Folder\SubFolder\3.txt");
